    ...
    {!collapsed ? <div className="space-y-5 border-t p-4">
      ...
      {section.type === "hero_slider" ? <div className="space-y-3 rounded-xl border p-4">
        ...
        {section.slides.map((slide, slideIndex) => <div key={slide.id} className="space-y-3 rounded-xl border bg-background p-3">
          ...
          <ImageUploadField label="Slide image" value={slide.imageUrl} onChange={(value) => changeSlide(slideIndex, "imageUrl", value)} />
        ...
        <div className="grid gap-4 md:grid-cols-2"><ImageUploadField label="Main image" value={section.imageUrl} onChange={(value) => change("imageUrl", value)} /><ImageUploadField label="Background image" value={section.backgroundImageUrl} onChange={(value) => change("backgroundImageUrl", value)} /></div>
