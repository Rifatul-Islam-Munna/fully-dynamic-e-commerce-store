...
export function renderProductCollectionSection(
    ...
    return (
      ...
      >
        ...
        <SectionTagRow
          ...
          className="mt-4"
        />
        <div className="mt-5 rounded-none bg-surface-container/18 p-3 sm:p-4">
    ...
    return (
      ...
      >
        <div className="grid gap-4 lg:grid-cols-[300px_minmax(0,1fr)] lg:items-start">
          <aside className="rounded-none bg-surface-container-low/50 px-5 py-6 sm:px-6">
          ...
          <div className="rounded-none border border-border/70 bg-surface p-3 sm:p-4">
            <ProductGrid products={products} className="gap-4" />
          </div>
        </div>
      </section>
    ...
    return (
      ...
      >
        <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_280px]">
          <div className="order-2 rounded-none bg-surface-container/18 p-3 sm:p-4 lg:order-1">
          ...
          <aside className="order-1 rounded-none border border-border/70 bg-surface-container-low/30 px-5 py-6 lg:order-2">
  ...
  if (variant === "spotlight_board") {
    return (
      <section
        key={sectionKey}
        className="overflow-hidden rounded-none border border-border/70 bg-surface shadow-none"
      >
  ...
  if (variant === "banner_top") {
    return (
      <section key={sectionKey}>
        <div className="rounded-none bg-primary px-4 py-5 text-on-primary sm:px-6 sm:py-6">
        ...
        <div className="rounded-none border border-t-0 border-border/70 bg-surface p-3 sm:p-5">
  ...
  if (variant === "floating_header") {
    return (
      <section key={sectionKey} className="relative pt-8 sm:pt-10">
        <div className="absolute inset-x-4 top-0 z-10 mx-auto max-w-lg rounded-none border border-border/60 bg-surface px-4 py-4 shadow-none sm:px-6 sm:py-5">
          <SectionHeading title={title} copy={introCopy} compact />
        ...
        <div className="rounded-none border border-border/70 bg-surface-container/15 px-3 pb-3 pt-20 sm:px-5 sm:pb-5 sm:pt-24">
          <ProductGrid products={products} className="gap-3" />
        </div>
      </section>
    );
    ...
    return (
      <section key={sectionKey} className="space-y-4">
        <div className="grid gap-3 sm:grid-cols-2">
          <div className="rounded-none border border-border/70 bg-surface px-4 py-4 sm:px-5 sm:py-5">
            <SectionEyebrow label="Collection" secondary={metaText} />
            <h2 className="mt-2 text-xl font-semibold tracking-tight text-on-surface sm:text-2xl">
              {title}
            </h2>
          </div>
          <div className="flex items-center rounded-none border border-border/70 bg-surface-container/15 px-4 py-4 sm:px-5 sm:py-5">
  ...
  if (variant === "numbered_list") {
    return (
      <section
        key={sectionKey}
        className="rounded-none border border-border/70 bg-surface p-3 sm:p-5"
      >
        <div className="flex items-start gap-3 border-b border-border/70 pb-4 sm:gap-4">
          <div className="flex size-12 shrink-0 items-center justify-center rounded-none bg-primary/10 text-xl font-bold text-primary sm:size-14">
            {products.length}
          </div>
  ...
  return (
    <section
      key={sectionKey}
      className="rounded-none bg-surface-container-low/50 p-3 sm:p-6"
    >
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
      ...
      <div className="mt-5 rounded-none bg-surface p-3 sm:p-4">
