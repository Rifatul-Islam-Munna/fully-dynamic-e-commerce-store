...
export function renderCustomBannerSection(
          ...
          <div className="flex flex-wrap items-center gap-3">
            {hasImage ? (
              <MediaFrame
                ...
                frameClassName="rounded-[22px] border border-border/70 bg-surface/88 p-1.5"
              />
            ) : null}
    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-4xl">
          <div className="rounded-[34px] bg-surface/88 px-6 py-8 text-center shadow-[0_30px_90px_-65px_rgba(15,23,42,0.24)] backdrop-blur-md">
            <SectionEyebrow label="Featured section" secondary={subtitle} />
          ...
          {hasImage ? (
            <div className="mt-6 flex justify-center">
              <MediaFrame
                ...
                frameClassName="rounded-[32px] border border-border/70 bg-surface/88 p-3"
              />
            </div>
          ) : null}
        </div>
  ...
  if (variant === "media_left") {
    return (
      <section
        key={sectionKey}
        className="rounded-[40px] border border-border/70 bg-surface p-5 shadow-[0_30px_90px_-65px_rgba(15,23,42,0.22)] sm:p-7"
      >
          ...
          {hasImage ? (
            <div className="relative">
              <MediaFrame
                ...
                frameClassName="rounded-[34px] bg-surface-container-low/50 p-3"
              />
              <div className="absolute left-6 top-6 rounded-full bg-surface/92 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.16em] text-on-surface shadow-sm">
                Media first
              </div>
            </div>
          ) : (
    ...
    return (
      ...
      >
        <div className="grid gap-5 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
          <div className="rounded-[32px] bg-surface px-5 py-6 shadow-[0_28px_80px_-60px_rgba(15,23,42,0.22)] sm:px-6">
            <SectionEyebrow label="Featured section" secondary={subtitle} />
            <div className="mt-5 space-y-5">
              <SectionHeading title={title} copy={sectionCopy} />
              <div className="grid gap-3 sm:grid-cols-2">
                <DetailTile
                  ...
                  className="bg-surface-container/18"
                />
                <DetailTile
                  icon={Sparkles}
          ...
          {hasImage ? (
            <MediaFrame
              ...
              frameClassName="rounded-[34px] bg-surface p-3 shadow-[0_28px_80px_-60px_rgba(15,23,42,0.24)]"
            />
          ) : (
            <SupportPanel
              title="Summary panel"
  ...
  if (variant === "dual_panel") {
    return (
      <section
        key={sectionKey}
        className="rounded-[40px] border border-border/70 bg-surface-container-low/50 p-5 sm:p-7"
      >
        <div className="grid gap-5 lg:grid-cols-2">
          <div className="rounded-[32px] bg-surface px-5 py-6 shadow-[0_26px_80px_-60px_rgba(15,23,42,0.22)] sm:px-6">
            <SectionEyebrow label="Featured section" secondary={subtitle} />
            <div className="mt-5 space-y-5">
              <SectionHeading title={title} copy={sectionCopy} />
              <SectionTagRow
          ...
          <div className="rounded-[32px] bg-surface px-4 py-4 shadow-[0_26px_80px_-60px_rgba(15,23,42,0.22)]">
            {hasImage ? (
        ...
        <div className="grid gap-5 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
          {hasImage ? (
            <MediaFrame
              ...
              frameClassName="rounded-[36px] border border-border/70 bg-surface p-4 shadow-[0_32px_90px_-62px_rgba(15,23,42,0.26)]"
            />
          ) : (
            <SupportPanel
              title="Framed visual"
    ...
    return (
      ...
      >
        <div className="grid gap-5 lg:grid-cols-[0.86fr_1.14fr] lg:items-end">
          <div className="space-y-5 rounded-[32px] bg-surface px-5 py-6 shadow-[0_30px_90px_-65px_rgba(15,23,42,0.24)] sm:px-6 lg:-mb-6">
            <SectionEyebrow label="Featured section" secondary={subtitle} />
            <SectionHeading title={title} copy={sectionCopy} />
            <DetailTile
              icon={Sparkles}
          ...
          {hasImage ? (
            <div className="relative lg:ml-8">
              <MediaFrame
                ...
                frameClassName="rounded-[34px] bg-surface p-3 shadow-[0_32px_90px_-65px_rgba(15,23,42,0.26)]"
              />
              <div className="absolute bottom-6 left-6 rounded-[22px] bg-surface/92 px-4 py-3 shadow-sm">
  ...
  if (variant === "soft_poster") {
    return (
      ...
      >
        <div className="absolute inset-0 bg-surface/76" />
        <div className="relative z-10 mx-auto max-w-4xl space-y-6 text-center">
          <div className="rounded-[34px] bg-surface/88 px-6 py-8 shadow-[0_30px_90px_-65px_rgba(15,23,42,0.22)] backdrop-blur-md">
            <SectionEyebrow label="Featured section" secondary={subtitle} />
            <div className="mt-5 space-y-5">
              <SectionHeading title={title} copy={sectionCopy} />
              <SectionTagRow
          ...
          {hasImage ? (
            <MediaFrame
              ...
              frameClassName="rounded-[34px] border border-border/70 bg-surface/90 p-3"
            />
          ) : null}
        </div>
      </section>
        ...
        <div className="grid gap-5 lg:grid-cols-[1fr_430px] lg:items-center">
          ...
          {hasImage ? (
            <MediaFrame
              ...
              alt={title}
              className="h-80 rounded-[28px] sm:h-[420px]"
              frameClassName="rounded-[34px] bg-surface-container/18 p-3"
            />
          ) : (
            <SupportPanel
              title="Split layout"
  ...
  if (variant === "info_strip") {
    return (
      <section
        key={sectionKey}
        className="rounded-2xl border border-border/70 bg-surface p-3 sm:rounded-[28px] sm:p-5"
      >
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <div className="min-w-0 flex-1 space-y-1">
            ...
            <h2 className="text-base font-semibold tracking-tight text-on-surface sm:text-lg">
              {title}
            </h2>
            {sectionCopy ? (
      ...
      <div className="grid gap-5 lg:grid-cols-[1fr_420px] lg:items-center">
        ...
        {hasImage ? (
          <MediaFrame
            ...
            frameClassName="rounded-[30px] bg-surface p-3"
          />
        ) : (
          <SupportPanel
